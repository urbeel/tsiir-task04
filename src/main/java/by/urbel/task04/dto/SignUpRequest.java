...
public class SignUpRequest {
    ...
    @NotBlank(message = Messages.PHONE_NOT_EMPTY)
    @Size(max = 20, message = Messages.PHONE_SIZE)
    private String phone;
    @NotBlank(message = Messages.ADDRESS_NOT_EMPTY)
    @Size(max = 255, message = Messages.ADDRESS_SIZE)
